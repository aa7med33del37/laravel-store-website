...
<body>
    <div class="text-center">
        ...
        <p>Thank You For Purchasing With {{ $appSetting->website_name ?? 'Online Store'}}</p>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="15%" class="fw-bold">${{ $orderItem->price * $orderItem->quantity }}</td>
                @php
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with {{ $appSetting->website_name ?? 'Website Name' }}
    </p>
